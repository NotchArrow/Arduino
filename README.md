...
This repository contains the code for some of my larger Arduino and breadboarding projects. Some of the code is relatively messy, but it could be a great starting point for anyone looking to work on similar projects. This repository is intentionally separate from my work in logical simulators and computer architecture sandboxes.

Many of the project folders contain separate README files with descriptions or showcases.
